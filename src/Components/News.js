...
const News = (props)=> {
    ...
    const updateNews = async ()=> {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=851ece81053c49a599f4d231831ff8f9&page=${page}&pageSize=${props.pageSize}`;
        setLoading(true)
